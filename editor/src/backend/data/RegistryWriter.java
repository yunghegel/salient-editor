...
public class RegistryWriter
{
    ...
    public void writeToResourceRegistry(ObjectMap<Class, Object> map) {
    ...
    public void writeToResourceRegistry(Class clazz, String name, String path) throws IOException {
        ...
        Log.info("RegistryWriter", "Added an instance of " + clazz.getSimpleName() + " to the resource registry");
    }

    public void writeAllToResourceRegistry() throws IOException {
        int reg = Perf.start("res_registry_write_time");
        Array<Triple<Class,String,String>> resources = ResourceRegistry.resources;
        JsonArray jsonArray = ResourceRegistry.getResourcesAsJson();
        ...
        Perf.end(reg);
        Log.info("RegistryWriter", "Added all instances to the resource registry");
    }

        public void writeToComponentRegistry(Class clazz, String name, String path) {
        JsonObject jsonObject = new JsonObject();
